...
public interface TransactionProcessor extends Observable<List<Transaction>,TransactionProcessor.Event> {
    ...
    Transaction newTransaction(short deadline, byte[] senderPublicKey, Long recipientId,
                               long amountNQT, long feeNQT, String referencedTransactionIdFullHash) throws NhzException.ValidationException;

    Transaction newTransaction(short deadline, byte[] senderPublicKey, Long recipientId,
                               long amountNQT, long feeNQT, String referencedTransactionFullHash, Attachment attachment) throws NhzException.ValidationException;
