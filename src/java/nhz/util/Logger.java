...
public final class Logger {
    ...
    static {
        debug = Nhz.getBooleanProperty("nhz.debug");
        enableStackTraces = Nhz.getBooleanProperty("nhz.enableStackTraces");
        PrintWriter printWriter = null;
        try {
            printWriter = new PrintWriter((new BufferedWriter(new OutputStreamWriter(new FileOutputStream(Nhz.getStringProperty("nhz.log"))))), true);
