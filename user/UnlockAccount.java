...
public final class UnlockAccount extends UserServlet.UserRequestHandler {
    ...
    JSONStreamAware processRequest(HttpServletRequest req, User user) throws IOException {
        ...
        if (account == null) {
            ...
            try (DbIterator<? extends Block> blockIterator = Nhz.getBlockchain().getAllBlocks(account, 0)) {
            ...
            try (DbIterator<? extends Transaction> transactionIterator = Nhz.getBlockchain().getAllTransactions(account, (byte)-1, (byte)-1, 0, null)) {
