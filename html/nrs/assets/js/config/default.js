/*
|------------------------------------------------------------------------------
| Nxs - Nhz Client GUI System
|------------------------------------------------------------------------------
|
| Created By:   Cody Jassman
| Version:      0.3.7
| Last Updated: March 16, 2014
| Source:       http://github.com/Regulus343/Nxs (or, simply, Nhz alias "Nxs")
| 
| The Nxs GUI system (pronounced "Nexus") for the official Nhz client is a
...
var config = {
	...
	*/
	...
	| match the "nhz-default.properties file" in Nhz's "conf" directory.
	|
	*/
	'apiServerPort': 7775,
	...
	*/
	...
	|
	*/
	'secretPhraseFieldDefaultVisible': false,
	...
	|
	*/
	'secretPhraseRequireStrong': false,
	...
	*/
	...
	|
	*/
	'blockUrl': 'http://explorer.nhzcrypto.org/?page=block&height=[blockId]',
	...
	|
	*/
	'accountUrl': 'http://explorer.nhzcrypto.org/?page=account&id=[accountId]',
	...
	|
	*/
	'transactionUrl': 'http://explorer.nhzcrypto.org/?page=transaction&id=[transactionId]',
	...
	*/
	...
	|--------------------------------------------------------------------------
	|
	| If true, the latest version of Nhz (NRS) that is checked is the beta
	...
	*/
	...
	/*
	|--------------------------------------------------------------------------
	| Maximum amounts of blocks to display
	|--------------------------------------------------------------------------
	|
	| Number of blocks shown in the Recent Blocks list. Set this lower on slower machines.
	|
	*/
	'showMaxBlocks': 75
