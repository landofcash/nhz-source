...
final class BlockImpl implements Block {
    ...
    boolean verifyGenerationSignature() throws BlockchainProcessor.BlockOutOfOrderException {
        ...
        try {
            ...
            BigInteger target = BigInteger.valueOf(Nhz.getBlockchain().getLastBlock().getBaseTarget()).multiply(BigInteger.valueOf(account.getEffectiveBalance())).multiply(BigInteger.valueOf(elapsedTime));
